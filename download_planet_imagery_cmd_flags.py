...
parser.add_argument("-o", "--order_name", help="Order Name")
parser.add_argument("-r", "--roi", help="ROI Path (.geojson)")
parser.add_argument("-t1", "--time1", help="Start time (YYYY-MM-DD)")
...
def create_combined_filter(roi,
                           time1,
                           time2):
    """
    inputs:
